package impl.model.command.listeners;
...
/**
 * Listener for handling "MOVE" commands
 */
public class MoveCommandListener {
    private final Map<String, Piece> pieces;
    private final Board board;
    private final CursorPositionManager cursorManager;

    public MoveCommandListener(Map<String, Piece> pieces, Board board, CursorPositionManager cursorManager) {
        this.pieces = pieces;
        this.board = board;
    ...
    public boolean supports(Command cmd) {
        return cmd.getType().equals("MOVE");
    }
